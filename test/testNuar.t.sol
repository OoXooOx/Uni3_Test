...
contract testNuar is Test, TestUtils {
    ...
    UniswapV3Pool pool = UniswapV3Pool(0x67B62f0cb3039e2c1efc64e853Db7317Db4f3974);
    ERC20Mintable token0 = ERC20Mintable(0x03ab458634910AaD20eF5f1C8ee96F1D6ac54919);
    ERC20Mintable token1 = ERC20Mintable(0x6B175474E89094C44Da98b954EedeAC495271d0F);
    ...
    function addLiquidity1000weiOfToken0() public {
        ...
        token0.approve(address(manager), 1000);
     ...
     function testFORKSwapSellEth() public {
